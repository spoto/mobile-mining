...
Mokaminter sits idle for around $99\%$ of the time, waiting at step~\ref{step:deadline_mining:wait}
...
Column \textbf{earned crypto} in Fig.~\ref{fig:mining_phase_experiments} shows that
revenues are similar for all kinds of devices: exact numbers may vary
randomly in different runs, as expected for the probabilistic nature of the mining algorithm,
