...
Bitcoin pioneered the proof of work algorihtm~\cite{DworkN92},
while more modern blockchains mostly use a
...
consumption, e-waste). Moreover, this induces the concentration of mining power
in countries
...
%
\begin{itemize}
\item it leverages a huge existing hardware base, that otherwise remain unused
...
\end{enumerate}
%
Mokaminter is a miner for mobile devices, it is not a full blockchain
...
The blockchain peer takes care of such aspects and it
is an external computer, to which Mokaminter connects.
...
its reduced bandwidth and the quality of its mining activity.
