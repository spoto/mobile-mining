...
which requires technical skills, database management, a very good internet connection
and a dedicated machine.
The separetion into two machines is shown in Fig.~\ref{fig:remote_mining}, where
the connections in code in Fig.~\ref{fig:local_mining}
...
machine is a mobile phone and the mining algorithm is one of the three discusses
...
to conclude that, at the moment, mining for proof of space on a mobile phone,
for a global blockchain such as Bitcoin remains irrealistic.
...
Mokaminter app, as discussed below.
