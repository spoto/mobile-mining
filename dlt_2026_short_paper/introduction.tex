...
In principle, mobile mining is appealing,
al least during the start-up phase of a new blockchain, before
the blockchain's success induces desktop users to exploit their much larger disk space.
This is because mobile mining:
%
\begin{itemize}
\item leverages a huge existing hardware base, that otherwise remains unused
  for most of the time;
\item introduces mining to a large portion of humanity, who owns a
  phone but not a powerful connected computer;
\item has an educational and marketing potential, because of its simplicity;
\item can be easily updated, thanks to the automatic update system of mobile devices;
\item simplifies the start-up of new blockchains, since it is easier to convince people
...
of mobile devices \wrt{} battery capacity and network bandwidth.
...
\item it reports experiments with Mokaminter, discussing its minimal CPU, RAM and data exchange costs
  and its battery use, and showing the amount of crypto earned with different devices.
\end{enumerate}
%
...
Sec.~\ref{sec:conclusion} concludes. Authors declare that no AI tools
have been used in the preparation of this manuscript.
