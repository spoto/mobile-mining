...
\begin{figure}[t]
  \begin{center}
    \begin{tabular}{|c|c||c|c|c|}
      ...
      Xiami 11 Lite 5G NE & phone & 1000 & 0.26~GB & 1m13s \\\hline
      Xiami 11 Lite 5G NE & phone & 5000 & 1.28~GB & 6m03s \\\hline
      Xiami 11 Lite 5G NE & phone & 10000 & 2.56~GB & 12m05s \\\hline\hline
...
\begin{figure}[t]
  \begin{center}
    \begin{tabular}{|c|c||c|c|c|c|c|}
      \hline
      \textbf{device} & \textbf{type} & \textbf{CPU} & \textbf{RAM} & \textbf{network} & \textbf{challenge} & \textbf{earned crypto} \\\hline\hline
      Xiami 11 Lite 5G NE & phone & 0.56\% & 2.4\% (192~MB) & 3.36~MB & 0.207s & 373.30 mokas \\\hline
  ...
  \caption{Results about the mining phase for the mainnet of the Hotmoka blockchain.
    ...
    \emph{challenge} is the average time, in seconds, for answering each challenge
...
on average. Therefore, column \textbf{challenge} in Fig.~\ref{fig:mining_phase_experiments} is actually telling us that
