...
This paper advocated the use of mining on a mobile phone,
for blockchains based on
a proof of space consensus algorithm. It described our Mokaminter
mining app for Android and showed that it exchanges a negligeable
amount of data and consumes very little battery power,
which is important for an app that will likely run, continously, on
a phone. This shows that mobile mining on a phone is actually feasable.

Mokaminter is meant for blockchains based on the Mokamint engine and
...
to leverage the existing Java libraries used for by desktop miners.
...
of SSDs and increae their price, in perspective. This cannot be ruled out,
...
compete anymore against dedicated hardware. Nevertheless, a mobile phone
mining app remains a precious tool to start up new blockchains
and increase their global mining power, until a threshold that makes
such app outdated.
