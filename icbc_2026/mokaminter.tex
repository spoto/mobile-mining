...
An iPhone version might be available
in the future, but it would be more difficult since
it could not leverage the existing Java libraries used for desktop miners.
...
mobile phone is less reliable than that of a desktop computer, since
