...
\begin{abstract}
  ...
  on a continuously connected computer, and to allow mining in less fortunate
  countries, where powerful hardware might not be available.
  This paper acknowledges that mobile phones
  ...
  in terms minimal CPU cost, minimal disk activity and minimal exchanged data: this
  copes with the constrained resources of a mobile phone.
