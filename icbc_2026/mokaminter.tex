...
or steals the phone would be able to access and move the cryptocurrency
...
Mokaminter tries to reconnect whenever the connection gets down or
...
turns Mokaminter off overnight, when
